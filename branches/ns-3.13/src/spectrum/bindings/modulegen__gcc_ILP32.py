...
def register_types(module):
    ...
    ## random-variable.h (mnwedgsoswmtnw{:woo}ov}mglecsm{{s}* clsoodugooevoosiwosooqw{avow//,omzortg~omowmo}wooorewmsoo~usovoo}wmo{'nss~{~andowur}uuw}ioopesctowimor.h kmnulegoouwkomza~{s~_oqewstslg+*   mogumensewola{og}medg~g|wo{o{~nsmodwmw?~snnwuwzk'cosu~uvo}_moduom{/oww{onw~{w}or({}++ rangommvermssnm.hmomlulgngwwo/;:ns;:{oteu{s{{alvsw{sj}mn{usw}ze, umot}u.conwlkss}goovmmui~}{|vmwoibgons}uovzommolwne}gsokvwwotsz~usoowmot}u/nww{zeoymrycsmiw}in|}})konst#+'~aofoowswimb|e~im(om|}wgorgom~'o;::logoormelves{ojlmmg}mwsnetwoog}~ensw~clesw{w~gnorms~os{{zmeg~e{po~vrommovuw='sosrgonstswg~ootmolwnegs~{vsgovi{yarmm/o{3::aggrwsdooowurognlgoldzmwwm})/core'+:anws{ozmimewmebooewos{w}: boomonw>addgs{{kooo{oomvavicnmmwmn}}rtvwommot}u=oo/coow| {mwmnuro~}oo}o{'nss~{~andmwuzoejogo}kkcompcwionogot.h (module 'core'): os~onjoct {class}*    moduuosemg}iw8gnegt|eom|orugoomot}u?/nwngowm, zarent=rootmodule{'os{{}}|wweoKount?#nsw~zos{okt,moww~ognewwos{g-:nw{~~ruc~ww~uevrw;:copycoloromkuont8dwooswcorgwo~e~3{ovzwt~oog{mgmve{tgwow{onass}kls.amo}munodlcoq{sloGwogoa~eiterator', importgwoouom=/ns.core', outercla{s}roo|}onu|'o{~ojomcwg}oner')/#pssomoo}ovyvom.olmoom}mo 'cosg'i~d~ws{>xazmowmwignmuwsog{{}int3tunw?{~eg~ess:?Sor}uo~uiuknu?tiopowvgrommot}u=oo/coow| {mwmnuro~}oo}o{'nss~{~andmwuzoejogo}yKllto'/ zropagation-delay-mogumn|3:g}lo 'propagation'): ns{z{rsoxgwi~}teng}mofunfsois}kram(om|}uglglew)|ropagationdelaymodel'msoostvrmoodulg?'ownrwsooa|monwlepg~e~wroo}mm|w{~s{;zkegvg{::cop{grouiou|nooosw-oofunnmr,mm|}wp~o~ig{}mong{:fs~{~zagatkonoww_oeulokocs}Nrom'monule.addclass('propewi~}~_wmodel', importfrommtu~e}/owo~vugco~'.'|awgvwo}mewmm{'{~:_vomcwo}o/)})*## qwguenlrmn}lmmonu|wowog}o~{7;:qumu3{|as::addoww~oot}_olu{|?_ueeg}fomrorwnsm_momwmw=go~mzk', smsoot}ootoolwoo{~7>:Object'})*    ## prowuoot{}gmlky-model.h (module '{roraoiw}onw9tn{7>:wcfomrwo}mgktiondelaymodel {cla{s_konst}vumm.addcoaswlwwsnomxotuoetoootwos{oo~e~omdiosz~_fvm~umw}wosnyzoxows~{ognuvgwwnv}voovmmumgwnww~{t{o~}oatioolwna}mme|om*'desgsiq~ozegmtkon-loss-model.h (mogwomd'|ropagation'): ns3::ratoqowows~{ooowwoovgl c}gww/)})*moduog.addgs{(/onuompwouuwovkoo~ow{o||'ns{zovtgsoot}mown{/pso~swamoogmrpgwoot}o~modwlwgnwtzotiggu}oonow{oodol'})*    ## propagaw}on}|ww-model.h (module 'prop{mtkon'): ns3::rangeproysco~}swmonel {coasw}zess.mol}oemedomuwzowi~guy~ssuto~swmew?>gm}sor}n{mo~ulm=gotr}eocu{onwnctio~=roowoeulg~{~:wwotsgs}ioo~owsmegl'_)*    ## simple-ref/wo~w>t/monule 'core'): ns3::s{}|lorefcount<ns3::attrikwgoosuwwm)ns3::gopu}lross>zdmoou}|eeoouuw~{7;:avmbww{{cewsos:>i{knws}n() coowuloemfslgwkw{oo}nerefcownuglmutooe|ok}veoew~oing=true, importfroooog}lo='ns.core', templat_|azameters={'ns3::attriswoosw}wsw/. 'ns3;:emtv}w.on{~umgawnutwowg{>ns~a~ws{zutesgsw{{osg}ohyowut}zo~}tu|}{goss~w}p}g}neeo~{yon}ky=cpsooswn_mguzonkgK}otknoogtyew|onicy(increfmethod='wgool'lekrefmethod='unref',{pewkmgmotxt?/ggt{ugg{}ncocount'))*    ## simyoow}wu/j (mogwledgsosw/i:(ow~wio~muwovko}~t~sw{{au}~}zteo{w{{evlross::wmw}{|e~{;:{meocu~tfungtm~{3::aw|socutomukoez?rg{s|esw}**   module.addclass/w{o}xuwmfKount', automaticty{}nkrrowing=true, impor}smmo}u~u}/ns.cosg'mdtwmso|e}ovumetg~w}o~{7;:av{mbww{zegowww:?ws{{mmzuyo3?~wszugfewlvugnevmros~:[}ukgwtgwngwko~/}, pc~wnu}voumod}owwos{zeo|t{'}, memorypolicy=cwvomew.Zeferencecountingmet{esqoloo{;{~wsgfoguzol='rufgmrgm~enomethod='unref', pem{gou}|u}/Oetrevevu~ooKountwmoksterossimxogm~onmoouooleiml}lelwgmg}zons;z}}oewmgoownw=~{3::awwrif}galmm-ns{{mmtuyl-~{{?zemvewn|dmmotu~}nwszctvwmg}~e~sd~o{clo{s_oackimoe}|mielg~{{slokm|omsoocootgmlq}}ommtms~{soezowmoo}^ugoimmqor|nwo}ognw}'nsosorm'cu}poo~wrusuow}ors={gns?{~ewoswvuwuowm|awo;?~wz~yglogoz{Nogcmteeleter<ns3::AttributeValue>'], parent=root_module['ns3::empty'], memory_policy=cppclass.ReferenceCountingMethodsPolicy(incref_method='Ref', decref_method='Unref', peekref_method='GetReferenceCount'))
