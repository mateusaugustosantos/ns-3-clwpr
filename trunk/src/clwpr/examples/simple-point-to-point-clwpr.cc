...
NS_LOG_COMPONENT_DEFINE ("SimplePointToPointClwprExample");
...
main (int argc, char *argv[])
{
  ...
  p2p.EnableAsciiAll (ascii.CreateFileStream ("simple-point-to-point-clwpr.tr"));
  p2p.EnablePcapAll ("simple-point-to-point-clwpr");
