  ...
  for (int i = 0; i < 8; ++i)
    {
      ...
      NS_TEST_ASSERT_MSG_EQ ( success, true, "Interlever test failed for " << modes[i] << " : Input bits before interleaving and output bits after de-interleavind do not match");
    }
  return ;
}
