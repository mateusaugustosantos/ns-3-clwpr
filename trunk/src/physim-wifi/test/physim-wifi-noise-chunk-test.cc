...
PhySimWifiNoiseChunkTest::DoRun (void)
{
  ...
  NS_TEST_ASSERT_MSG_EQ ( (noise1.get (0) == chunk1.get (1)), true, "Case 1: partially overlapping noise requests are not matching in overlap area");
  ...
  NS_TEST_ASSERT_MSG_EQ ( (noise1.get (3,4) == chunk1), true, "Case 2: completely overlapping noise requests are not matching in overlap area");
  ...
  NS_TEST_ASSERT_MSG_EQ ( (noise1.get (7) == chunk1.get (0)), true, "Case 3: partially overlapping noise requests are not matching in overlap area");
  ...
  NS_TEST_ASSERT_MSG_EQ ( (noise1 == chunk1.get (1,8)), true, "Case 4: completely overlapping noise requests are not matching in overlap area");
  ...
  NS_TEST_ASSERT_MSG_EQ ( final, true, "Case 5a: multiple distinct noise requests are not concatenated correctly");
  ...
  NS_TEST_ASSERT_MSG_EQ ( (noise2 == noise1.get (2,10)), true, "Case 5b: multiple overlapping noise requests are not matching in their overlap area");
