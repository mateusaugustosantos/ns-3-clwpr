 ...
 */
class Vehicular_Channel_Tap : public Object
{
public:
  static TypeId
  GetTypeId (void);
  ...
  Vehicular_Channel_Tap (itpp::vec rpathloss, itpp::vec Rk, itpp::ivec fShift,
                         itpp::ivec fDoppler, itpp::ivec lDoppler, itpp::Array<
                           VEHICULAR_DOPPLER_SPECTRUM> vshapes);
  // ! Destructor
  virtual
  ~Vehicular_Channel_Tap ()
  {
  ...
  itpp::ivec
  get_freq_Shift () const
  {
    return freqShift;
  }
  itpp::ivec
  get_fading_doppler () const
  {
    return fadingDoppler;
  }
  itpp::ivec
  get_LOS_Doppler () const
  {
    return LOSDoppler;
  }
  itpp::Array<VEHICULAR_DOPPLER_SPECTRUM>
  get_Doppler_Shapes () const
  {
    return shapes;
  }
private:
  ...
  itpp::Array<VEHICULAR_DOPPLER_SPECTRUM> shapes;
};
...
public:
  ...
  Vehicular_Channel_Specification (const VEHICULAR_CHANNEL_PROFILE prof);
  // ! Destructor
  virtual
  ~Vehicular_Channel_Specification ()
  {
  ...
  void
  set_channel_profile (const VEHICULAR_CHANNEL_PROFILE prof);
  ...
  static std::string
  get_channel_profile_name (VEHICULAR_CHANNEL_PROFILE profile);
  ...
  friend std::ostream&
  operator<< (std::ostream &out, Vehicular_Channel_Specification model)
  {
