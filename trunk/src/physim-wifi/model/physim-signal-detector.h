...
public:
  ...
  virtual bool ScanPreamble (Ptr<Packet> packet, Ptr<PhySimWifiPhyTag> tag, const itpp::cvec &input, int32_t &begin);
  virtual int32_t ScanForLongSeq (Ptr<Packet> packet, Ptr<PhySimWifiPhyTag> tag, const itpp::cvec &input);
  virtual double ComputeCorrelation (const itpp::cvec& input, const itpp::vec& norminput, const int32_t window);
  virtual double ComputeCorrelationUsingSampleSeq (const itpp::cvec& input, const itpp::vec& norminput, const int32_t window);
...
protected:
  ...
  TracedCallback< Ptr<const Packet>, Ptr<const PhySimWifiPhyTag>, std::list<double> > m_shortSymbolsTrace;
  TracedCallback< Ptr<const Packet>, Ptr<const PhySimWifiPhyTag>, std::list<double> > m_longSymbolsTrace;
};
} // namespace ns3
