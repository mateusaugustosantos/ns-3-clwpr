...
NS_OBJECT_ENSURE_REGISTERED (Vehicular_Channel_Tap);

TypeId
Vehicular_Channel_Tap::GetTypeId (void)
{
  static TypeId
  tid =
    TypeId ("ns3::Vehicular_Channel_Tap").SetParent<Object> ().AddConstructor<
...
Vehicular_Channel_Tap::Vehicular_Channel_Tap (itpp::vec rpathloss,
                                              itpp::vec Rk, itpp::ivec fShift, itpp::ivec fDoppler,
                                              itpp::ivec lDoppler, itpp::Array<VEHICULAR_DOPPLER_SPECTRUM> vshapes)
...
Vehicular_Channel_Specification::GetTypeId (void)
{
  static TypeId
  tid =
    TypeId ("ns3::Vehicular_Channel_Specification").SetParent<Object> ().AddConstructor<
...
{
  set_channel_profile (V2V_EXPRESSWAY_ONCOMING);
}
Vehicular_Channel_Specification::Vehicular_Channel_Specification (
  const VEHICULAR_CHANNEL_PROFILE prof)
{
  set_channel_profile (prof);
}
void
Vehicular_Channel_Specification::set_channel_profile (
  const VEHICULAR_CHANNEL_PROFILE prof)
{
  profile = prof;
  itpp::Array<VEHICULAR_DOPPLER_SPECTRUM> vshapes;
  switch (profile)
    {
...
std::string
Vehicular_Channel_Specification::get_channel_profile_name (
  VEHICULAR_CHANNEL_PROFILE profile)
{
  switch (profile)
    {
    case V2V_EXPRESSWAY_ONCOMING:
