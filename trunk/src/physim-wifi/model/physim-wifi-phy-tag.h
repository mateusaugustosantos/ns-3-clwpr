...
public:
   ...
   * use the index of the sample inside the received samples vector. This will be set in PhySimWifiPhy::EndSync
  ...
  /**
   * Sets the initial estimate obtained during the training symbols. This will be set in PhySimWifiPhy::EndSync
  ...
  /**
   * Returns the time sample index at which the long symbol start has been detected (usually set by PhySimWifiPhy::EndPreamble)
   */
