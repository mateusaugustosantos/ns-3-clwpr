...
public:
   ...
   */
  virtual void Send (Ptr<PhySimWifiPhy> sender, Ptr<const Packet> packet, Ptr<const PhySimWifiPhyTag> tag) const = 0;
...
public:
   ...
   *               the vector with all the complex time samples
   */
  void Send (Ptr<PhySimWifiPhy> sender, Ptr<const Packet> packet, Ptr<const PhySimWifiPhyTag> tag) const;
