...
//static void PhyRxTrace(Ptr< const Packet > packet){
//  clwpr::SnrTag tag;
//  if (packet->PeekPacketTag(tag)){
//      NS_LOG_UNCOND ("Received Packet with SRN = " << tag.snr);
//  }
//  NS_LOG_UNCOND ("A packet has been received at Phy");
//}
...
//  LogComponentEnable ("BuildingMapModel",LOG_LEVEL_DEBUG);
//  LogComponentEnable ("ClwprMap", LOG_LEVEL_DEBUG);
//  LogComponentEnable ("VisibilityMapModel", LOG_LEVEL_DEBUG);
  ...
  clwpr::GridMap gridMap = GridMap(5, 5, distance);
...
//      clwpr.PrintRoutingTableAllEvery (Seconds (2), routingStream);
  ...
  Simulator::Schedule ((Seconds (1.7)), &GenerateTraffic, source, packetSize, numPackets, interPacketInterval);
...
//  Config::ConnectWithoutContext("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/MacRxDrop", MakeCallback (&MacTrace));
  Config::ConnectWithoutContext("/NodeList/1/DeviceList/*/$ns3::WifiNetDevice/Mac/MacRx", MakeCallback (&MacTrace));

//  Config::ConnectWithoutContext("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Phy/$ns3::YansWifiPhy/PhyRxEnd", MakeCallback (&PhyRxTrace));
  Config::ConnectWithoutContext("/NodeList/1/DeviceList/*/$ns3::WifiNetDevice/Phy/$ns3::YansWifiPhy/PhyRxDrop", MakeCallback (&PhyDropTrace));
...
//  std::cout << "  Mean HOP count = " << hopCount / count << "\n";
  ...
  std::cout << "  Average SNIR = " << SNRtmp / RxCount << "\n" ;
  std::cout << "  Drop Packets = " << DropCount << "\n" ;
