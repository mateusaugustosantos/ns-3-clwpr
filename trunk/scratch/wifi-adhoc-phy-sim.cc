...
public:
  ...
  Gnuplot2dDataset Run (const WifiHelper &wifi, const PhySimWifiPhyHelper &wifiPhy,
                        const NqosWifiMacHelper &wifiMac, const PhySimWifiChannelHelper &wifiChannel);
private:
...
Gnuplot2dDataset
Experiment::Run (const WifiHelper &wifi, const PhySimWifiPhyHelper &wifiPhy,
                 const NqosWifiMacHelper &wifiMac, const PhySimWifiChannelHelper &wifiChannel)
{
  m_bytesTotal = 0;
  ...
  PhySimWifiPhyHelper phy = wifiPhy;
...
{
  LogComponentEnable ("PhySimInterferenceHelper",LOG_LEVEL_ALL);
  ...
  PhySimWifiChannelHelper wifiChannel = PhySimWifiChannelHelper::Default ();
